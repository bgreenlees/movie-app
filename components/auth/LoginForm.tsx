  ...
  return (
    <div className="space-y-4 w-full max-w-md">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2 border rounded-md transition-colors hover:bg-[var(--hover-bg)] disabled:opacity-50 disabled:cursor-not-allowed"
